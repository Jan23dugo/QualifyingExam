...
(function() {
    ...
    // Initialize timepicker for the duration field
    $(document).ready(function() {
        $('.timepicker').timepicker({
            showMeridian: false, // Use 24-hour format
            minuteStep: 5,       // Adjust step to select duration conveniently
            defaultTime: '00:00' // Set default time to show initially
        });
    });
